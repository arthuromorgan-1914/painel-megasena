...
export default function App() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      ...
      {/* Desempenho */}
      <div className="shadow rounded bg-gradient-to-r from-green-600 to-emerald-700 text-white">
        <div className="p-5 text-center">
          <h2 className="text-xl font-semibold mb-2">Índice de Desempenho Acumulado</h2>
        </div>
      </div>
      ...
      <div className="flex justify-end">
        <button onClick={checarAtualizacoes} disabled={checando}
          className={`px-4 py-2 rounded border ${checando ? 'opacity-60' : ''}`}>
          {checando ? 'Checando...' : 'Checar novo sorteio'}
        </button>
      </div>
